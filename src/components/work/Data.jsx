...
import Doc1 from '../../assets/MakalahFlorAmor.pdf';
import Doc2 from '../../assets/DOC2.pdf';
import Doc4 from '../../assets/DokumenTambahanPaperku.pdf';
import Doc5 from '../../assets/Sertifikatlomba.pdf';
import Doc6 from '../../assets/MODULEUPHORIA.pdf';
import Doc7 from '../../assets/dokumentambahan2.pdf';

export const projectsData = [
  {
    id: 1,
    image: Work1,
    title: 'App E-Commerce Mobile Flor Amor',
    desc: 'Membuat Aplikasi E-Commerce Tanaman Hias berbasis Mobile untuk memenuhi tugas project Mobile Programming',
    info1: 'Merancang Layout dan Navigasi Aplikasi',
    info2: 'Mengelola database untuk memanagement Member dan Product',
    info3: 'Mengimplementasikan Fitur-Fitur seperti Autentikasi, Profile, Keranjang Belanja dan Manajemen Produk',
    info4: 'Melakukan testing dan debugging untuk memastikan Aplikasi berkerja dengan baik dan aman',
    apk: [
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="flutter">
    ...
    url: 'https://github.com/Ratuufaradiiba/TokoKita',
    category: 'app',
  },
  {
    id: 2,
    image: Work2,
    title: 'App E-Commerce Pet Paw',
    info1: 'Merancang Layout Aplikasi Mobile',
    info2: 'Merancang Navigasi Aplikasi',
    info3: 'Memilih setiap warna, font, logo dan icon-icon yang terkait dengan tema Hewan',
    info4: 'Membuat Mock Up halaman Awal masuk, Login, Daftar, Home, Checkout dan lain sebagainya.',
    apk: (
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="figma">
    ...
    url: 'https://www.figma.com/proto/lIdMvQlD5bbk7ylV3Ub3qV/Aplikasi-PET-PAW?type=design&node-id=10-77&scaling=scale-down&page-id=10%3A74&starting-point-node-id=10%3A77',
    desc: 'Mendesign Aplikasi Mobile Pet Paw yaitu Aplikasi yang berfungsi untuk mengadopsi hewan peliharaan yang lucu untuk dijadikan teman rumah.',
    category: 'design',
    doc: (
      <a download="" href={Doc2} className="button button flex">
        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            d="M15.25 22.7502H9.25C3.82 22.7502 1.5 20.4302 1.5 15.0002V9.00024C1.5 3.57024 3.82 1.25024 9.25 1.25024H14.25C14.66 1.25024 15 1.59024 15 2.00024C15 2.41024 14.66 2.75024 14.25 2.75024H9.25C4.64 2.75024 3 4.39024 3 9.00024V15.0002C3 19.6102 4.64 21.2502 9.25 21.2502H15.25C19.86 21.2502 21.5 19.6102 21.5 15.0002V10.0002C21.5 9.59024 21.84 9.25024 22.25 9.25024C22.66 9.25024 23 9.59024 23 10.0002V15.0002C23 20.4302 20.68 22.7502 15.25 22.7502Z"
            fill="var(--container-color)"
  ...
  },
  {
    id: 3,
    image: Work3,
    title: 'Website E-Commerce Organic Food',
    info1: 'Merancang Layout',
    info2: 'Merancang Navigasi website',
    info3: 'Memilih warna, font, logo dan icon-icon yang sesuai dengan tema organik',
    info4: 'Membuat Mock Up halaman Home, Categories, Product, About, dan Contact.',
    desc: 'Mendesign website E-commerce Organic Food dengan berbagai Animasi untuk memenuhi tugas UI/UX.',
    category: 'design',
    apk: (
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="figma">
        <path fill="#0ACF83" d="M8,24c2.208,0,4-1.792,4-4v-4H8c-2.208,0-4,1.792-4,4C4,22.208,5.792,24,8,24L8,24z"></path>
    ...
    url: 'https://www.figma.com/proto/TmiprwOuwAcZ1dazk6KRg2/Tugas-2-Ratu-Faradiba-Al-Isra-Syam?type=design&node-id=9-104&scaling=min-zoom&page-id=0%3A1&starting-point-node-id=9%3A104',
  },
  {
    id: 4,
    image: Work4,
    title: 'Website Paperku',
    desc: 'Membuat Aplikasi berbasis Website untuk memenuhi Final Project Studi Independent Fullstack Web Developer',
    info1: 'Mengelola database untuk memanagement jurnal, kategori, author dan user',
    info2: 'Mengimplementasikan fitur-fitur seperti autentikasi, validasi, pagination, dan CRUD',
    info3: 'Membuat halaman Dashboard Admin untuk memanagement Jurnal, Kategori, Author dan User',
    info4: 'Melakukan testing dan debugging untuk memastikan website bekerja dengan baik dan aman',
    apk: [
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 256" id="laravel">
        <g fill="#F35045">
          <path d="M160.445 208c2 2.889 3.222 2.667 4.777 2 1.555-.667 81.556-27.667 84-28.555 2.444-.889 1.667-1.667.89-2.89-.778-1.222-27.445-37.444-28.779-39.555-1.333-2.111-2-1.667-4.111-1l-84.805 22.067S158.445 205.11 160.445 208zM256 171.115v-42.398c-9.541 2.542-21.609 5.756-26.373 7.023 7.187 9.616 18.423 24.665 26.373 35.375zM229.545 83.521c-1.307.297-30.247 5.527-32.03 5.764-1.782.238-1.188 1.248-.475 2.258l25.467 34.943s31.139-7.725 33.041-8.141c.154-.034.305-.07.452-.107v-4.627c-5.66-7.177-21.08-26.718-22.413-28.544-1.604-2.199-2.734-1.842-4.042-1.546z"></path>
          ...
          <path d="M60.412 165.288c2.6-.595 51.313-12.253 52.353-12.476 1.04-.223 1.708-.817.594-2.747-1.114-1.93-64.934-112.09-64.934-112.09-.589-1.011-.421-1.348-2.022-1.264-1.427.076-37.538 3.298-45.898 3.996a51.038 51.038 0 0 0-.461 5.331c8.487 17.375 57.199 117.837 57.472 118.655.297.892.297 1.189 2.896.595z"></path>
        </g>
      </svg>,
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="php">
        <path fill="#878EB7" d="M12,18.5c6.626,0,12-2.908,12-6.5c0-3.592-5.374-6.5-12-6.5C5.374,5.5,0,8.408,0,12C0,15.592,5.374,18.5,12,18.5L12,18.5z"></path>
        <path
          fill="#23282C"
          d="M5.029 15.641l.326-1.73c1.541 0 2.497.117 3.382-.737.979-.927 1.234-2.576.536-3.402C8.909 9.339 8.325 9.126 7.529 9.126h-2.65l-1.226 6.515H5.029L5.029 15.641zM6.068 10.154c1.424 0 2.392-.158 2.115 1.325v-.001c-.296 1.564-1.343 1.402-2.629 1.402L6.068 10.154 6.068 10.154zM10.759 13.904l.704-3.731c1.114 0 1.575-.046 1.778.179.21.232.101.486-.476 3.553h1.388c.6-3.172.866-3.843.31-4.369-.528-.502-1.623-.413-2.805-.413l.326-1.73h-1.368L9.39 13.904H10.759L10.759 13.904zM15.787 15.641l.326-1.73c1.62 0 2.516.097 3.383-.737.979-.927 1.234-2.576.536-3.402-.364-.433-.949-.646-1.744-.646h-2.651l-1.23 6.515H15.787L15.787 15.641zM16.822 10.154c1.432 0 2.392-.158 2.115 1.325v-.001c-.3 1.588-1.376 1.402-2.629 1.402L16.822 10.154 16.822 10.154z"
        ></path>
        <path
          fill="#767C9F"
          d="M8.032,12H5.72l-0.166,0.881c0.22,0,0.433,0.005,0.637,0.005C7.023,12.885,7.696,12.806,8.032,12L8.032,12z M24,12h-3.752c-0.155,0.436-0.409,0.849-0.752,1.174c-0.703,0.677-1.425,0.741-2.538,0.741c-0.259,0-0.539-0.004-0.844-0.004l-0.326,1.73h-1.38L15.094,12h-0.571c-0.099,0.51-0.226,1.133-0.372,1.905h-1.388c0.154-0.817,0.275-1.435,0.365-1.905h-2.011l-0.359,1.904H9.39L9.748,12H9.49c-0.155,0.436-0.409,0.849-0.752,1.174c-0.695,0.671-1.434,0.742-2.466,0.742c-0.282,0-0.585-0.005-0.916-0.005l-0.326,1.73H3.652L4.338,12H0l0,0c0,3.592,5.374,6.5,12,6.5C18.626,18.5,24,15.592,24,12L24,12L24,12z"
        ></path>
        <path
          fill="#1E2326"
          d="M9.49 12H8.032c-.337.806-1.009.885-1.842.885-.204 0-.417-.005-.637-.005L5.72 12H4.338l-.685 3.641h1.377l.326-1.73c.33 0 .634.005.916.005 1.032 0 1.771-.072 2.466-.742C9.08 12.849 9.334 12.436 9.49 12L9.49 12zM11.118 12h-1.37L9.39 13.904h1.369L11.118 12 11.118 12zM14.524 12H13.13c-.09.471-.211 1.088-.365 1.905h1.388C14.298 13.133 14.424 12.509 14.524 12L14.524 12z"
        ></path>
        <path fill="#767C9F" d="M18.788,12h-2.313l-0.166,0.881c0.238,0,0.469,0.007,0.69,0.007C17.795,12.887,18.455,12.8,18.788,12L18.788,12z"></path>
        <path
          fill="#1E2326"
          d="M20.248,12h-1.46c-0.333,0.801-0.993,0.887-1.789,0.887c-0.221,0-0.452-0.007-0.69-0.007L16.474,12h-1.38l-0.687,3.641h1.38l0.326-1.73c0.306,0,0.586,0.004,0.844,0.004c1.113,0,1.836-0.064,2.538-0.741C19.839,12.849,20.093,12.436,20.248,12L20.248,12z"
        ></path>
      </svg>,
    ...
    doc: (
      <a download="" href={Doc4} className="button button flex">
        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            d="M15.25 22.7502H9.25C3.82 22.7502 1.5 20.4302 1.5 15.0002V9.00024C1.5 3.57024 3.82 1.25024 9.25 1.25024H14.25C14.66 1.25024 15 1.59024 15 2.00024C15 2.41024 14.66 2.75024 14.25 2.75024H9.25C4.64 2.75024 3 4.39024 3 9.00024V15.0002C3 19.6102 4.64 21.2502 9.25 21.2502H15.25C19.86 21.2502 21.5 19.6102 21.5 15.0002V10.0002C21.5 9.59024 21.84 9.25024 22.25 9.25024C22.66 9.25024 23 9.59024 23 10.0002V15.0002C23 20.4302 20.68 22.7502 15.25 22.7502Z"
            fill="var(--container-color)"
    ...
    url: 'https://github.com/Ratuufaradiiba/FP4-Paperku',
    category: 'web',
  },
  {
    id: 5,
    image: Work5,
    title: 'Redesign Aplikasi inaRISK Personal',
    desc: 'Mendesign ulang Aplikasi Mobile inaRISK Personal untuk mengikuti Lomba ICWeek 2022 BNPB Indonesia',
    info1: 'Melakukan pengamatan design aplikasi sebelumnya',
    info2: 'Merancang Navigasi Aplikasi dan Layout',
    info3: 'Memilih warna, font, logo dan icon-icon yang sesuai dengan tema yang sudah disesuaikan inaRisk',
    info4: 'Membuat Mock Up halaman Home, Fitur, Informasi, Video, Notifikasi dan lain sebagainya',
    apk: (
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="figma">
        <path fill="#0ACF83" d="M8,24c2.208,0,4-1.792,4-4v-4H8c-2.208,0-4,1.792-4,4C4,22.208,5.792,24,8,24L8,24z"></path>
        <path fill="#A259FF" d="M4,12c0-2.208,1.792-4,4-4h4v8H8C5.792,16,4,14.208,4,12L4,12z"></path>
    ...
    category: 'design',
    doc: (
      <a download="" href={Doc5} className="button button flex">
        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            d="M15.25 22.7502H9.25C3.82 22.7502 1.5 20.4302 1.5 15.0002V9.00024C1.5 3.57024 3.82 1.25024 9.25 1.25024H14.25C14.66 1.25024 15 1.59024 15 2.00024C15 2.41024 14.66 2.75024 14.25 2.75024H9.25C4.64 2.75024 3 4.39024 3 9.00024V15.0002C3 19.6102 4.64 21.2502 9.25 21.2502H15.25C19.86 21.2502 21.5 19.6102 21.5 15.0002V10.0002C21.5 9.59024 21.84 9.25024 22.25 9.25024C22.66 9.25024 23 9.59024 23 10.0002V15.0002C23 20.4302 20.68 22.7502 15.25 22.7502Z"
            fill="var(--container-color)"
    ...
    url: 'https://www.figma.com/proto/eAHiBzMxbvQmU7z0cPaSWU/Lomba-INARisk?type=design&node-id=835-9722&scaling=scale-down&page-id=0%3A1&starting-point-node-id=75%3A8',
  },
  {
    id: 6,
    image: Work6,
    title: 'Website E-Commerce EuphoriaHolic-Store',
    desc: 'Membuat Website E-Commerce Khusus Pakaian untuk memenuhi Tugas Project Mata Kuliah Web Programming 3',
    info1: 'Merancang Navigasi Website dan Layout',
    info2: 'Mengimplementasikan fitur-fitur seperti keranjang belanja, profile, checkout, pembayaran, dan manajemen produk',
    info3: 'Mengelola database produk, pelanggan, laporan dan transaksi',
    info4: 'Melakukan testing dan debugging untuk memastikan website bekerja dengan baik dan aman',
    apk: [
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="php">
        <path fill="#878EB7" d="M12,18.5c6.626,0,12-2.908,12-6.5c0-3.592-5.374-6.5-12-6.5C5.374,5.5,0,8.408,0,12C0,15.592,5.374,18.5,12,18.5L12,18.5z"></path>
    ...
    url: 'https://github.com/Ratuufaradiiba/EuphoriaHolic-Store',
  },
  {
    id: 7,
    image: Work7,
    title: 'Website Inventoris Kantor',
    desc: 'Membuat Website Inventoris Kantor sebagai Mini Project Studi Independen Fullstack Web Developer dengan PHP Native',
    info1: 'Mencari Template dan merangcang Navigasi Website dan Layout',
    info2: 'Mengimplementasikan fitur-fitur seperti List Barang Keluar dan Masuk, Dashboard Barang, dan CRUD manajemen produk',
    info3: 'Mengelola database barang, barang masuk dan keluar, jenis barang dan user',
    info4: 'Melakukan testing dan debugging untuk memastikan website bekerja dengan baik dan aman',
    apk: [
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="php">
        <path fill="#878EB7" d="M12,18.5c6.626,0,12-2.908,12-6.5c0-3.592-5.374-6.5-12-6.5C5.374,5.5,0,8.408,0,12C0,15.592,5.374,18.5,12,18.5L12,18.5z"></path>
    ...
    category: 'web',
    doc: (
      <a download="" href={Doc7} className="button button flex">
        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            d="M15.25 22.7502H9.25C3.82 22.7502 1.5 20.4302 1.5 15.0002V9.00024C1.5 3.57024 3.82 1.25024 9.25 1.25024H14.25C14.66 1.25024 15 1.59024 15 2.00024C15 2.41024 14.66 2.75024 14.25 2.75024H9.25C4.64 2.75024 3 4.39024 3 9.00024V15.0002C3 19.6102 4.64 21.2502 9.25 21.2502H15.25C19.86 21.2502 21.5 19.6102 21.5 15.0002V10.0002C21.5 9.59024 21.84 9.25024 22.25 9.25024C22.66 9.25024 23 9.59024 23 10.0002V15.0002C23 20.4302 20.68 22.7502 15.25 22.7502Z"
            fill="var(--container-color)"
    ...
    url: 'https://github.com/Ratuufaradiiba/Inventaris',
  },
];
